...
public class SearchFiles {
	...
	/**
	 * Usage:\tjava com.hanshow.support.server.lucene.SearchFiles [-index dir]
	 * [-field f] [-repeat n] [-queries file] [-query string] [-raw] [-paging
	 * hitsPerPage]\n\nSee http://lucene.apache.org/core/4_1_0/demo/ for details.";
	 * 
	 * @param indexPath index目录
	 * @param field 
	 * @param queries
	 * @param repeat
	 * @param raw
	 ...
	 * @throws Exception
	 */
	public static void search(String indexPath, String field, String queries, int repeat, boolean raw, String queryString, int hitsPerPage) throws Exception {

		hitsPerPage = hitsPerPage <= 0 ? 10 : hitsPerPage;

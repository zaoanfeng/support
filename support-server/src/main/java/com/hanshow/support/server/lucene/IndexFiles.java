...
public class IndexFiles {
	...
	/** Index all text files under a directory. */
	public static void index(String indexPath, String docsPath, boolean isUpdate) {
		String usage = "java com.hanshow.support.server.lucene.IndexFiles" + " [-index INDEX_PATH] [-docs DOCS_PATH] [-update]\n\n"

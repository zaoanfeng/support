    ...
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      ...
      <div class="createPost-main-container">
        ...
        <!-- <el-form-item style="margin-bottom: 40px;" label-width="45px" label="摘要:">
          <el-input v-model="postForm.content_short" type="textarea" class="article-textarea" autosize placeholder="请输入内容"/>
          <span v-show="contentShortLength" class="word-counter">{{ contentShortLength }}字</span>
        </el-form-item> -->
        <el-form-item style="margin-bottom: 40px;" label-width="45px" label="内容:">
          <markdown-editor v-model="postForm.content" :options="{hideModeSwitch:true}" height="500px"/>
        </el-form-item>
